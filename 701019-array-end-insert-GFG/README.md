# [Array End Insert](https://www.geeksforgeeks.org/problems/array-insert-at-end/1)
## Easy
...
Output: [1, 2, 3, 4, 5, 90]Explanation: After inserting 90 at the end, we have array elements as 1 2 3 4 5 90.
Input: arr[] = [1, 2, 3], val = 50
Output: [1, 2, 3, 50]
Explanation: After inserting 50 at the end, we have array elements as 1 2 3 50.

Constraints:1 ≤ arr.size() ≤ 1050 ≤ element, arr[i]&nbsp;≤ 106